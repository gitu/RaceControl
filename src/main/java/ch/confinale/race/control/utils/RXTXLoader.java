package ch.confinale.race.control.utils;
...
public class RXTXLoader {
    ...
    public static void load(OperatingSystem os, Architecture arch) throws IOException {
        ...
        System.out.println(os.toString().toLowerCase() + File.separator + arch.toString().toLowerCase() + File.separator + os.getLibPath());
        final InputStream source = ClassLoader.getSystemResourceAsStream(os.toString().toLowerCase() + File.separator + arch.toString().toLowerCase() + File.separator + os.getLibPath());
